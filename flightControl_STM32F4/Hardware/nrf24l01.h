...
#define SPI_CE_H()   GPIO_SetBits(GPIOE, GPIO_Pin_9) 
#define SPI_CE_L()   GPIO_ResetBits(GPIOE, GPIO_Pin_9)

#define SPI_CSN_H()  GPIO_SetBits(GPIOE, GPIO_Pin_8)
#define SPI_CSN_L()  GPIO_ResetBits(GPIOE, GPIO_Pin_8) 
